# header-luxury-layout

## Purpose

Defines the requirements for the Capella Hotel Group luxury website header — a full-width sticky three-zone bar (language selector · brand navigation with emblem · CTA button) that establishes the editorial, whitespace-driven aesthetic of the brand.
