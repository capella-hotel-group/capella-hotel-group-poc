...
> Copied from [adobe/skills content-driven-development/resources/cdd-philosophy.md](https://github.com/adobe/skills/tree/main/skills/aem/edge-delivery-services/skills/content-driven-development/resources/cdd-philosophy.md) with a TypeScript note added.
...
> **TypeScript note**: In this project, complex decoration logic lives in `src/blocks/{name}/{name}.ts`. TypeScript strictness (`strictNullChecks`, typed parameters) makes the code safer, not harder. The compiler helps you find bugs that would only appear in the browser otherwise.
