...
Defines the advance mode for the lighting-interaction block. In advance mode the background plane is static and three transparent overlay planes (decoration-left, decoration-right, foreground) animate on top of it using sin-wave and pointer-velocity-driven vertex displacement.
