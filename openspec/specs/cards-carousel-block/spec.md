...
Defines the `cards-carousel` block: a horizontally scrollable strip of hotel cards supporting drag-to-scroll, prev/next arrow navigation, snap-on-release, and responsive cards-per-view.
