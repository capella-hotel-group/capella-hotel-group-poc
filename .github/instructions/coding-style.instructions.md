...
### Stylelint
- Config: `stylelint-config-standard` v40
- Scans: `src/blocks/**/*.css`, `src/styles/*.css`
- Run `npm run lint:css` or `npm run lint:fix` to check/fix
...
| `src/**/*.css` | Stylelint --fix, then Prettier |
| `*.html`, `*.md` | Prettier |
