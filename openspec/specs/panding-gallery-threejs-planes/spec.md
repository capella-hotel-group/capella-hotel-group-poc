...
Defines how the immersive scene constructs and synchronises Three.js `PlaneGeometry` meshes to mirror the DOM image grid, including texture loading, camera configuration, and scroll-motion offset synchronisation.
