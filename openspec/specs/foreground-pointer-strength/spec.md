...
Defines the dedicated pointer strength constant for the foreground overlay plane in advance mode. The foreground plane's emotional role differs from the decor planes and requires independent tuning of its pointer velocity response via a separate constant and optional debug override.
