...
Defines the module structure for the lighting-interaction Three.js scene code. The scene implementation is split into focused sibling modules to separate concerns: async asset loading, pure frame-update math, debug rendering, and orchestration.
