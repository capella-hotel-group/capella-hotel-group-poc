...
Defines per-vertex displacement behaviour for `panding-gallery` immersive mode planes, producing a bendy-card effect driven by pointer proximity and scroll energy.
