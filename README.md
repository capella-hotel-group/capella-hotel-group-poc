...
For complete prerequisites, environment setup, and workflow onboarding, see the **[SDD Onboarding Guide](docs/sdd-onboarding-guide.md)**.

Quick start:

```bash
npm install                     # install dependencies
npm install -g @adobe/aem-cli  # AEM local proxy
npm install -g openspec        # SDD artifact management
npm run start                  # dev server at localhost:3000
```

### AEM Reference Documentation

- [AEM Edge Delivery Services](https://www.aem.live/docs/)
- [WYSIWYG Authoring with Universal Editor](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/wysiwyg-authoring/authoring)
