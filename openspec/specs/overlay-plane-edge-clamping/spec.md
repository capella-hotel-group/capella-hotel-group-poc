...
Defines the edge-clamping mechanism for advance-mode overlay planes in the lighting-interaction block. A `borderMask` Float32Array ensures outer-edge vertices of each plane remain at their rest positions regardless of pointer velocity or sin-wave animation, preventing coverage gaps at the viewport boundary.
